...
function setupHandlers(app) {
    ...
    //
    // HTTP GET API from host 'advertising' path '/advertising' and return advertising.
    //
        ...
        return new Promise((resolve, reject) => {
            http.request( // Get the list of videos from the metadata microservice.
                ...
                (response) => {
                    ...
                    response.on("end", () => {
                        console.log("Get advertising : " + data)
    ...
    app.get("/upload", (req, res) => {
        http.request(
            ...
            (response) => {
                ...
                response.on("end", () => {
                    // Renders the upload page for display in the browser.
                    res.render("upload-video", {
                        advertising: JSON.parse(data)
                    });
                });
